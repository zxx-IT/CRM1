	...
	<form action="${ctp }/service/allot/list" method="POST">
		<table class="query_form_table" border="0" cellPadding="3"
			...
			<tr>
				...
				<td>
					<input type="text" name="search_GTD_createDate" size="10" />
					-
					<input type="text" name="search_LTD_createDate1" size="10" />
				</td>
			</tr>
		</table>
		<!-- 列表数据 -->
				...
				<c:forEach var="service" items="${page.content }">
					<tr>
						...
						<td class="list_data_text">
							...
							<select name="allotId" id="allotTo">
								<option value="">
									<c:if test="${service.allotTo.name != null}">
